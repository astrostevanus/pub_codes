...
whichdata="este"
h5f_techni = h5py.File("techni-"+str(whichdata)+"-fin.info", 'w')
pi=3.141592653589793
mjd,bjd,rvcor,hjd,airmass=np.loadtxt("wasp33-este.info",unpack=True,dtype="float")
...
#V system variation
#vsysmax= vstar+v_width
#vsysmin= vstar-v_width
vsysmax=80.
vsysmin=-80.
vsysstep= v_step
...
drvs= np.arange(np.min([v1,v2,v3,v4])-10., np.max([v1,v2,v3,v4])+10.+v_step, v_step)


#h5f_techni = h5py.File("techni-"+str(whichdata)+"-prev.info", 'w')
